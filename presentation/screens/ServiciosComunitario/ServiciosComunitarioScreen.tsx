...
import { styles } from './ServiciosComunitario.styles';



const ServiciosComunitarioScreen = () => {
  ...
  return (
    ...
    >
      <View style={styles.overlay}>
        <HeaderPage titulo="Servicios Comunitario" />
...
export default ServiciosComunitarioScreen;
